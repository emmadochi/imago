...
const List<BibleTranslation> kBibleTranslations = [
  ...
  BibleTranslation(abbreviation: 'NPB', description: '🇳🇬 Nigerian Pidgin Bible', fileName: 'KJV.bbl.mybible'),
  BibleTranslation(abbreviation: 'IGBO', description: '🟢 Igbo Bible (Baịbụl Nsọ)', fileName: 'KJV.bbl.mybible'),
  BibleTranslation(abbreviation: 'HAUSA', description: '🔴 Hausa Bible (Littafi Mai Tsarki)', fileName: 'KJV.bbl.mybible'),
  BibleTranslation(abbreviation: 'YORUBA', description: '🟡 Yoruba Bible (Bíbélì Mímọ́)', fileName: 'KJV.bbl.mybible'),
