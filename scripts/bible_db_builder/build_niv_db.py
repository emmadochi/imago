...
DB_NAME = "NIV.bbl.mybible"
TARGET_DIR = "../../mobile_app/assets/bible"
BASE_URL = "https://raw.githubusercontent.com/aruljohn/Bible-niv/main"
...
def main():
    ...
    total_verses = 0
    print(f"Building NIV Bible Database at {target_path}...")
    ...
    conn.commit()
    conn.close()
    print(f"\nSuccessfully built NIV Bible DB at {target_path} with {total_verses} total verses!")
